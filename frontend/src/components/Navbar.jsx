...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 h-16 bg-yt-sidebar/95 backdrop-blur-sm border-b border-yt-border z-40 flex items-center px-4 md:px-6">
      <div className="flex items-center gap-2.5">
        ...
        <h1 className="text-yt-text text-xl font-bold tracking-tight">Yost</h1>
      </div>
    </header>
  );
}
